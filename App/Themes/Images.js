// leave off @2x/@3x
const images = {
  logo: require('../Images/star-in-circle.png'),
  launch2: require('../Images/star-in-circle.png'),
  clearLogo: require('../Images/top_logo.png'),
  launch: require('../Images/launch-icon.png'),
  ready: require('../Images/roadie-app-logo.png'),
  ignite: require('../Images/ignite_logo.png'),
  igniteClear: require('../Images/ignite-logo-transparent.png'),
  tileBg: require('../Images/tile_bg.png'),
  background4: require('../Images/bg4.jpg'),
  background3: require('../Images/bg3.png'),
  background2: require('../Images/bg2.jpg'),
